...
export interface ApiWebsiteWebsite extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    website_subscription: Schema.Attribute.Relation<
      'oneToOne',
...
export interface ApiWebsiteSubscriptionWebsiteSubscription
  ...
  attributes: {
    ...
    subscripcion_activa: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    precio_stripe: Schema.Attribute.Enumeration<
      ['Sitio web $700-price_1QAMPXGChMK8V46WcFJ4CdGx']
    > &
      Schema.Attribute.DefaultTo<'Sitio web $700-price_1QAMPXGChMK8V46WcFJ4CdGx'>;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    role: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    user_type: Schema.Attribute.Enumeration<['client']> &
      Schema.Attribute.Required &
